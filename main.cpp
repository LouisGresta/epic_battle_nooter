...
{
    Attack defo1("deforestation" , "wallah je coupe des arbres", 1000, 0,0,type_table.getType("Plante"));
    ...
    Nooter nootnoot("The_Original_Nooter" , type_table.getType("Plante"),liste_atk_n ,10000,20,10,100 );
