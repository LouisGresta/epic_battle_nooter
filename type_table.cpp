...
void Type_table::initNormal(){
    ...
    Normal.addType({"Roche", 1});   Normal.addType({"Fantome", 1});     Normal.addType({"Dragon", 1});
    Normal.addType({"Acier", 1});   Normal.addType({"Fee", 1});         Normal.addType({"Noot", 1});
...
void Type_table::initFeu(){
    ...
    Feu.addType({"Normal", 1});  Feu.addType({"Feu", 1});         Feu.addType({"Eau", 1});
    Feu.addType({"Herbe", 1});   Feu.addType({"Electrique", 1});  Feu.addType({"Glace", 1});
    Feu.addType({"Combat", 1});  Feu.addType({"Poison", 1});      Feu.addType({"Sol", 1});
    Feu.addType({"Vol", 1});  Feu.addType({"Psy", 1});      Feu.addType({"Insecte", 1});
    Feu.addType({"Roche", 1});  Feu.addType({"Fantome", 1});      Feu.addType({"Dragon", 1});
    Feu.addType({"Acier", 1});  Feu.addType({"Fee", 1});      Feu.addType({"Noot", 1});
...
void Type_table::initEau(){
    ...
    Eau.addType({"Normal", 1});  Eau.addType({"Feu", 1});         Eau.addType({"Eau", 1});
    Eau.addType({"Herbe", 1});   Eau.addType({"Electrique", 1});  Eau.addType({"Glace", 1});
    Eau.addType({"Combat", 1});  Eau.addType({"Poison", 1});      Eau.addType({"Sol", 1});
    Eau.addType({"Vol", 1});  Eau.addType({"Psy", 1});      Eau.addType({"Insecte", 1});
    Eau.addType({"Roche", 1});  Eau.addType({"Fantome", 1});      Eau.addType({"Dragon", 1});
    Eau.addType({"Acier", 1});  Eau.addType({"Fee", 1});      Eau.addType({"Noot", 1});
...
void Type_table::initHerbe(){
    ...
    Herbe.addType({"Normal", 1});  Herbe.addType({"Feu", 1});         Herbe.addType({"Eau", 1});
    Herbe.addType({"Herbe", 1});   Herbe.addType({"Electrique", 1});  Herbe.addType({"Glace", 1});
    Herbe.addType({"Combat", 1});  Herbe.addType({"Poison", 1});      Herbe.addType({"Sol", 1});
    Herbe.addType({"Vol", 1});  Herbe.addType({"Psy", 1});      Herbe.addType({"Insecte", 1});
    Herbe.addType({"Roche", 1});  Herbe.addType({"Fantome", 1});      Herbe.addType({"Dragon", 1});
    Herbe.addType({"Acier", 1});  Herbe.addType({"Fee", 1});      Herbe.addType({"Noot", 1});
...
void Type_table::initElectrique(){
    ...
    Electrique.addType({"Normal", 1});  Electrique.addType({"Feu", 1});         Electrique.addType({"Eau", 1});
    Electrique.addType({"Herbe", 1});   Electrique.addType({"Electrique", 1});  Electrique.addType({"Glace", 1});
    Electrique.addType({"Combat", 1});  Electrique.addType({"Poison", 1});      Electrique.addType({"Sol", 1});
    Electrique.addType({"Vol", 1});     Electrique.addType({"Psy", 1});         Electrique.addType({"Insecte", 1});
    Electrique.addType({"Roche", 1});   Electrique.addType({"Fantome", 1});     Electrique.addType({"Dragon", 1});
    Electrique.addType({"Acier", 1});   Electrique.addType({"Fee", 1});         Electrique.addType({"Noot", 1});
...
void Type_table::initGlace(){
    ...
    Glace.addType({"Normal", 1});  Glace.addType({"Feu", 1});         Glace.addType({"Eau", 1});
    Glace.addType({"Herbe", 1});   Glace.addType({"Electrique", 1});  Glace.addType({"Glace", 1});
    ...
    Glace.addType({"Acier", 1});  Glace.addType({"Fee", 1});      Glace.addType({"Noot", 1});
...
void Type_table::initCombat(){
    ...
    Combat.addType({"Acier", 1});  Combat.addType({"Fee", 1});      Combat.addType({"Noot", 1});
...
void Type_table::initPoison(){
    ...
    Poison.addType({"Acier", 1});  Poison.addType({"Fee", 1});      Poison.addType({"Noot", 1});
...
void Type_table::initSol(){
    ...
    Sol.addType({"Acier", 1});  Sol.addType({"Fee", 1});      Sol.addType({"Noot", 1});
...
void Type_table::initVol(){
    ...
    Vol.addType({"Acier", 1});  Vol.addType({"Fee", 1});      Vol.addType({"Noot", 1});
...
void Type_table::initPsy(){
    ...
    Psy.addType({"Acier", 1});  Psy.addType({"Fee", 1});      Psy.addType({"Noot", 1});
...
void Type_table::initInsecte(){
    ...
    Insecte.addType({"Acier", 1});  Insecte.addType({"Fee", 1});      Insecte.addType({"Noot", 1});
...
void Type_table::initRoche(){
    ...
    Roche.addType({"Acier", 1});  Roche.addType({"Fee", 1});      Roche.addType({"Noot", 1});
...
void Type_table::initFantome(){
    ...
    Fantome.addType({"Acier", 1});  Fantome.addType({"Fee", 1});      Fantome.addType({"Noot", 1});
...
void Type_table::initDragon(){
    ...
    Dragon.addType({"Acier", 1});  Dragon.addType({"Fee", 1});      Dragon.addType({"Noot", 1});
...
void Type_table::initAcier(){
    ...
    Acier.addType({"Acier", 1});  Acier.addType({"Fee", 1});      Acier.addType({"Noot", 1});
...
void Type_table::initFee(){
    ...
    Fee.addType({"Acier", 1});  Fee.addType({"Fee", 1});      Fee.addType({"Noot", 1});
...
void Type_table::initNoot(){
    ...
    Noot.addType({"Normal", 1});  Noot.addType({"Feu", 1});         Noot.addType({"Eau", 1});
    Noot.addType({"Herbe", 1});   Noot.addType({"Electrique", 1});  Noot.addType({"Glace", 1});
    Noot.addType({"Combat", 1});  Noot.addType({"Poison", 1});      Noot.addType({"Sol", 1});
    Noot.addType({"Vol", 1});  Noot.addType({"Psy", 1});      Noot.addType({"Insecte", 1});
    Noot.addType({"Roche", 1});  Noot.addType({"Fantome", 1});      Noot.addType({"Dragon", 1});
    Noot.addType({"Acier", 1});  Noot.addType({"Fee", 1});      Noot.addType({"Noot", 1});
